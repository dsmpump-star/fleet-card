// Fleet Entry Checker — Firebase Cloud Messaging Service Worker
...
messaging.onBackgroundMessage(payload => {
  ...
  self.registration.showNotification(title || 'Fleet Entry Checker', {
    ...
    badge: '/fleet-card/fleet-icon-192.png',
